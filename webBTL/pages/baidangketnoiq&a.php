...
<head>
    ...
    <style>
        ...
        .bentrai{ flex-basis: 70%; }
        .benphai{ flex-basis: 30%; }
        .chiabocuc{ display: flex; }
        .hop{
            margin: 20px auto;
            max-width: 960px;
        }
        ...
        font-size: 0.9em;      /* Giảm kích thước font, bạn có thể điều chỉnh theo ý muốn */
...
<body>
    ...
    <!-- Thanh công cụ kích hoạt đăng bài -->
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()){
                ...
                <div class="post">
                    ...
                    <!-- Nút xóa bài đăng -->
                    <a href="delete_post.php?id=<?php echo $row['id']; ?>" class="delete-link" onclick="return confirm('Bạn có chắc muốn xóa bài đăng này?');">Xóa bài đăng</a>                </div>
                <?php
            }
        }
        $conn->close();
    ...
    <div class="modal" id="postModal">
        ...
        <!-- Form gửi dữ liệu POST đến submit_post.php -->
