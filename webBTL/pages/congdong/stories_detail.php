...
$stmt = $conn->prepare("SELECT id, title, description, image_url FROM stories WHERE id = ?");
...
$image_path = file_exists("image_url/" . $story['image_url']) 
...
<body>
    ...
    <section class="detail-container">
        ...
        <img src="<?php echo htmlspecialchars($image_path); ?>" alt="<?php echo htmlspecialchars($story['title']); ?>">
